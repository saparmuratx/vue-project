...
const handleUpdate = async () => {
  ...
  try {
    ...
    console.error("Couldn't update Job information");
    toast.error("Couldn't update Job information");
  }
}
    ...
    <div class="container m-auto max-w-2xl py-24">
      <div class="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
        <form @submit.prevent="handleUpdate">
          <h2 class="text-3xl text-center font-semibold mb-6">Update Job Information</h2>

          <div class="mb-4">
            <label for="type" class="block text-gray-700 font-bold mb-2">Job Type</label>
            <select v-model="state.job.type" id="type" name="type" class="border rounded w-full py-2 px-3" required>
          ...
          <div class="mb-4">
            ...
            <input v-model="state.job.title" type="text" id="name" name="name"
              class="border rounded w-full py-2 px-3 mb-2" placeholder="eg. CEO for OpenAI In San Francisco, Bay Area"
              required />
          </div>
          <div class="mb-4">
          ...
          <div class="mb-4">
            ...
            <select v-model="state.job.salary" id="salary" name="salary" class="border rounded w-full py-2 px-3"
              required>
          ...
          <div class="mb-4">
            ...
            <textarea v-model="state.job.company.description" id="company_description" name="company_description"
          ...
          <div class="mb-4">
            ...
            <input v-model="state.job.company.contactEmail" type="email" id="contact_email" name="contact_email"
          ...
          <div class="mb-4">
            ...
            <input v-model="state.job.company.contactPhone" type="tel" id="contact_phone" name="contact_phone"
